...
st.set_page_config(page_title="AI Video Subtitle", page_icon="🎬")
...
def _get_text_steps():
    ...
    steps = [
        (t("Word-level transcription"), _2_asr.transcribe),
        (
...
def main():
    st.title("🎬 AI Video Subtitle")
    st.markdown(button_style, unsafe_allow_html=True)
    welcome_text = t(
        "Welcome to AI Video Subtitle. Paste your dlazy API key in the sidebar to get started - one key covers translation, transcription and dubbing."
    )
    st.markdown(
