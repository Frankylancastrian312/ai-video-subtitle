        ...
        if row['cut_off'] == 1:
            ...
            for i, row in chunk_df.iterrows():
                ...
                for line_index, line in enumerate(lines):
                    ...
                    # float() on purpose: cur_time picks up numpy scalars from the
                    # dataframe, and numpy>=2 reprs those as "np.float64(x)", which
                    # breaks the eval() that reads this column back in _11.
